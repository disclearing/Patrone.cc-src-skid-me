...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
    ...
    void sendMessage(String message, boolean recording);

    void sendMessage(String[] messages, boolean recording);

    void sendMessage(net.md_5.bungee.api.chat.BaseComponent component, boolean recording);

    void sendMessage(boolean recording, net.md_5.bungee.api.chat.BaseComponent... components);
