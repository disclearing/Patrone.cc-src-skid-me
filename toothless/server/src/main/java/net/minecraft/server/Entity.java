...
public abstract class Entity implements ICommandListener {
    ...
    private boolean givingSprintKnockback; // Toothless - WTap mechanic
...
/*            if (flag) {
    ...
    public void setSprinting(boolean flag) {
        this.b(3, flag);
        setGivingSprintKnockback(flag);
    }

    public boolean isGivingSprintKnockback() {
        return this.givingSprintKnockback;
    }

    public void setGivingSprintKnockback(boolean flag) {
        this.givingSprintKnockback = flag;
    }
