...
public abstract class EntityHuman extends EntityLiving {
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            entityitem.owner = this; // Toothless
    ...
    public void attack(Entity entity) {
        if (entity.aD()) {
            if (!entity.l(this)) {
                ...
                if (this.isGivingSprintKnockback()) {
                    ++i;
                }
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            ...
                            entity.g(
                                    (-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.5F) * multiplier,
                                    0.00000031D,
                                    (MathHelper.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * 0.5F) * multiplier
                            );
                            this.motX *= ToothlessConfig.motMult;
                            this.motZ *= ToothlessConfig.motMult;
                            this.motY *= ToothlessConfig.motYMult;
                            */
                            entity.g(
                                    (-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * ToothlessConfig.knockbackExtraHorizontal),
                                    ToothlessConfig.knockbackExtraVertical,
                                    (MathHelper.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * ToothlessConfig.knockbackExtraHorizontal)
                            );
                        ...
                        if (entity instanceof EntityPlayer && entity.velocityChanged) {
                            ...
                            PlayerVelocityEvent event = new PlayerVelocityEvent(
                                    attackedPlayer.getBukkitEntity(),
