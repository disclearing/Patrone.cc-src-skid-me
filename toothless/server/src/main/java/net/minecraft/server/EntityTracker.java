...
//            entitytrackerentry.scanPlayers(this.world.players);
    ...
    public void updatePlayers() {
        List<EntityPlayer> arraylist = Lists.newArrayList();
        ...
        for (EntityPlayer anArraylist : arraylist) {
            for (EntityTrackerEntry entitytrackerentry1 : this.c) {
                if (entitytrackerentry1.tracker != anArraylist) {
                    entitytrackerentry1.updatePlayer(anArraylist);
                }
            }
        }
