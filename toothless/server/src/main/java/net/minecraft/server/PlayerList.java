...
public abstract class PlayerList {
    ...
    public EntityPlayer moveToWorld(EntityPlayer entityplayer, int i, boolean flag, Location location, boolean avoidSuffocation) {
        ...
        entityplayer1.playerConnection.sendPacket(new PacketPlayOutUpdateTime(entityplayer1.world.getTime(),
                entityplayer1.getPlayerTime(), entityplayer1.world.getGameRules().getBoolean("doDaylightCycle")));
        // CraftBukkit start
    ...
    public void sendPacketNearby(Entity entity, double d0, double d1, double d2, double d3, int i, Packet packet) {
        for (EntityPlayer entityplayer : this.players) {
            if (!entityplayer.getBukkitEntity().canSeeEntity(entity.getBukkitEntity())) {
                continue;
            }
    ...
    public void sendPacketNearby(EntityHuman entityhuman, double d0, double d1, double d2, double d3, int i, Packet packet) {
        sendPacketNearby(entityhuman, d0, d1, d2, d3, i, packet, false);
    }
    ...
    public void sendPacketNearby(EntityHuman entityhuman, double d0, double d1, double d2, double d3, int i, Packet packet, boolean self) {
        for (int j = 0; j < this.players.size(); ++j) {
            ...
            if ((self || entityplayer != entityhuman) && entityplayer.dimension == i) {
                double d4 = d0 - entityplayer.locX;
                double d5 = d1 - entityplayer.locY;
                double d6 = d2 - entityplayer.locZ;
