...
public class WorldManager implements IWorldAccess {
    ...
    public void a(Entity entity, String s, double d0, double d1, double d2, float f, float f1) {
        this.a.getPlayerList().sendPacketNearby(entity, d0, d1, d2, f > 1.0F ? (double) (16.0F * f) : 16.0D, this.world.dimension, new PacketPlayOutNamedSoundEffect(s, d0, d1, d2, f, f1));
    }
    ...
    // Toothless
    public void a(EntityHuman entityhuman, int i, BlockPosition blockposition, int j, boolean self) {
        this.a.getPlayerList().sendPacketNearby(entityhuman, (double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ(), 64.0D, this.world.dimension, new PacketPlayOutWorldEvent(i, blockposition, j, false), self);
    }
