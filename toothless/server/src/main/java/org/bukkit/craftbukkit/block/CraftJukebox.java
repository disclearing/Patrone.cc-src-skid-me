...
public class CraftJukebox extends CraftBlockState implements Jukebox {
    ...
    public CraftJukebox(final Block block) {
        ...
        jukebox = (BlockJukeBox.TileEntityRecordPlayer) world.getTileEntityAt(getX(), getY(), getZ());
    }

    public CraftJukebox(final Material material, BlockJukeBox.TileEntityRecordPlayer te) {
        super(material);
        world = null;
        jukebox = te;
    }
